...
tb:column(triggers, 18, 19, 7, 2, 0.5)
tb:column(triggers, 19, 19, 7, 2.3, 0.5)
tb:column(triggers, 20, 19, 7, 2.6, 0.5)
...
return tileset, quads, tileString, tileWidth, gravity, solid, triggers, backgrounds, '7-limbo'